...
# what does it use
quickskit uses many different module, for the video editing it uses [moviepy](https://zulko.github.io/moviepy/), for the website engin it uses [flask](https://flask.palletsprojects.com/en/1.1.x/quickstart/) and many more ([more info](https://github.com/Ugric/quickskits/blob/master/requirements.txt)
